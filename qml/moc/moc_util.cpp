...
QT_MOC_LITERAL(1, 5, 11), // "codeChanged"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 4) // "code"

    },
    "Util\0codeChanged\0\0code"
};
...
void Util::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Util::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Util::codeChanged)) {
                *result = 0;
                return;
            }
        }
